            ...
            $plan = ReadingPlan::query()->updateOrCreate(
                ...
                [
                    'name' => [
                        ...
                        'hu' => 'Biblia egy év alatt — 365 napos olvasóterv',
                        'es' => 'La Biblia en un año — Plan de lectura de 365 días',
                        'fr' => 'La Bible en un an — Plan de lecture de 365 jours',
                        'de' => 'Die Bibel in einem Jahr — Leseplan für 365 Tage',
                        'it' => 'La Bibbia in un anno — Piano di lettura di 365 giorni',
                    ],
                    'description' => [
                        ...
                        'hu' => 'Olvasd végig az egész Bibliát 365 nap alatt. Minden nap egy-egy szakaszt ölel fel az Ószövetségből, az Újszövetségből, a Zsoltárokból és a Példabeszédekből.',
                        'es' => 'Lee toda la Biblia en 365 días. Cada día combina un pasaje del Antiguo Testamento, del Nuevo Testamento, de los Salmos y de los Proverbios.',
                        'fr' => 'Lisez la Bible entière en 365 jours. Chaque jour associe un passage de l\'Ancien Testament, du Nouveau Testament, des Psaumes et des Proverbes.',
                        'de' => 'Lies die ganze Bibel in 365 Tagen. Jeder Tag verbindet einen Abschnitt aus dem Alten Testament, dem Neuen Testament, den Psalmen und den Sprüchen.',
                        'it' => 'Leggi tutta la Bibbia in 365 giorni. Ogni giorno unisce un brano dell\'Antico Testamento, del Nuovo Testamento, dei Salmi e dei Proverbi.',
                    ],
                    'image' => [
                        'en' => 'https://placehold.co/1200x630?text=Bible+in+a+Year',
                        'ro' => 'https://placehold.co/1200x630?text=Biblia+intr-un+an',
                        'hu' => 'https://placehold.co/1200x630?text=Biblia+egy+ev+alatt',
                        'es' => 'https://placehold.co/1200x630?text=Biblia+en+un+ano',
                        'fr' => 'https://placehold.co/1200x630?text=Bible+en+un+an',
                        'de' => 'https://placehold.co/1200x630?text=Bibel+in+einem+Jahr',
                        'it' => 'https://placehold.co/1200x630?text=Bibbia+in+un+anno',
                    ],
                    'thumbnail' => [
                        'en' => 'https://placehold.co/400x400?text=Bible+in+a+Year',
                        'ro' => 'https://placehold.co/400x400?text=Biblia+intr-un+an',
                        'hu' => 'https://placehold.co/400x400?text=Biblia+egy+ev+alatt',
                        'es' => 'https://placehold.co/400x400?text=Biblia+en+un+ano',
                        'fr' => 'https://placehold.co/400x400?text=Bible+en+un+an',
                        'de' => 'https://placehold.co/400x400?text=Bibel+in+einem+Jahr',
                        'it' => 'https://placehold.co/400x400?text=Bibbia+in+un+anno',
                    ],
